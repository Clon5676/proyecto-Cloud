...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://libraryuser:librarypass@database/library'
...
def get_books():
    ...
    return jsonify([{'id': book.id, 'title': book.title, 'author': book.author, 'is_available': book.is_available} for book in books])
